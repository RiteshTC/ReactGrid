...
/***/ (function(module, exports, __webpack_require__) {
	...
	var sameColumn = __webpack_require__(105);
	var ColumnUtils = __webpack_require__(5);
	var getScrollbarSize = __webpack_require__(15);
	var isColumnsImmutable = __webpack_require__(57);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _keyMirror = __webpack_require__(152);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _OverflowCell = __webpack_require__(118);

	var _OverflowCell2 = _interopRequireDefault(_OverflowCell);

	var _RowComparer = __webpack_require__(48);
	...
	var cellMetaDataShape = __webpack_require__(10);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _CellExpand = __webpack_require__(103);

	var _CellExpand2 = _interopRequireDefault(_CellExpand);

	var _ChildRowDeleteButton = __webpack_require__(104);
	...
	var React = __webpack_require__(2);
	var joinClasses = __webpack_require__(6);
	var EditorContainer = __webpack_require__(127);
	var ExcelColumn = __webpack_require__(11);
	var isFunction = __webpack_require__(22);
	var CellMetaDataShape = __webpack_require__(10);
	var SimpleCellFormatter = __webpack_require__(55);
	var ColumnUtils = __webpack_require__(5);
	var createObjectWithProperties = __webpack_require__(14);
	...
	var Cell = React.createClass({
	  ...
	  onCellContextMenu: function onCellContextMenu(e) {
	    var isArrowElement = e.target.classList.contains('row-arrow-handle');
	    var meta = this.props.cellMetaData;
	  ...
	  render: function render() {
	    ...
	    var rowArrow = !!this.props.column.isIndexColumn ? React.createElement('span', { className: 'row-arrow-handle' }) : null;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var joinClasses = __webpack_require__(6);
	var ExcelColumn = __webpack_require__(11);
	var ResizeHandle = __webpack_require__(47);
	var ContextDropDown = __webpack_require__(107);
	...
	function onArrowClick(e) {
	  ...
	  var headerCells = document.getElementsByClassName('is-open');
	  for (var i = 0; i < headerCells.length; i++) {
	    var el = headerCells[i];
	    el.classList.remove('is-open');
	  }

	  var headerCell = e.target.closest('.react-grid-HeaderCell');
	...
	var HeaderCell = React.createClass({
	  ...
	  handleArrowClick: function handleArrowClick(e) {
	    ...
	    if (e.target.classList.contains('arrow-handle') || e.target.parentElement.classList.contains('arrow-handle')) {
	      e.preventDefault();
	      e.stopPropagation();

	      //  click event handling
	      var _headerCells = document.getElementsByClassName('is-open');
	      for (var _i = 0; _i < _headerCells.length; _i++) {
	        var _el = _headerCells[_i];
	        _el.classList.remove('is-open');
	      }

	      var _headerCell = e.target.closest('.react-grid-HeaderCell');
	      _headerCell.classList.add('is-open');
	    }
	  ...
	  render: function render() {
	    ...
	    var contextDropDown = void 0;
	    contextDropDown = React.createElement(ContextDropDown, {
	      onDrag: this.onDrag,
	      onDragStart: this.onDragStart,
	      onDragEnd: this.onDragEnd,
	      isOpen: 'isactive'
	    ...
	    return React.createElement(
	      ...
	      cell,
	      React.createElement('span', { className: 'arrow-handle' }),
	      resizeHandle
	    );
	  }
	});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(2);
	var Draggable = __webpack_require__(108);
	__webpack_require__(12);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _ColumnMetrics = __webpack_require__(19);
	  ...
	  RowsContainer.prototype.renderRowsWithContextMenu = function renderRowsWithContextMenu() {
	    ...
	    return _react2['default'].createElement(
	      ...
	      _react2['default'].createElement(
	        ...
	        { id: 'reactDataGridContextMenu', holdToDisplay: -1 },
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  isEmptyArray: __webpack_require__(135),
	  isEmptyObject: __webpack_require__(136),
	  isFunction: __webpack_require__(22),
	  isImmutableCollection: __webpack_require__(137),
	  getMixedTypeValueRetriever: __webpack_require__(139),
	  isColumnsImmutable: __webpack_require__(57),
	  isImmutableMap: __webpack_require__(138),
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _RowsContainer = __webpack_require__(50);
	...
	var joinClasses = __webpack_require__(6);
	var PropTypes = React.PropTypes;
	var ScrollShim = __webpack_require__(122);
	var Row = __webpack_require__(33);
	var cellMetaDataShape = __webpack_require__(10);
	var RowUtils = __webpack_require__(49);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var ColumnMetrics = __webpack_require__(19);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var ContextDropDown = React.createClass({
	  displayName: 'ContextDropDown',
	  render: function render() {
	    return React.createElement(
	      'div',
	      { className: "context-menu " + this.props.isOpen },
	      React.createElement(
	        'ul',
	        null,
	        React.createElement(
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _ColumnUtils = __webpack_require__(5);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var ColumnMetrics = __webpack_require__(19);
	var ColumnUtils = __webpack_require__(5);
	var FooterRow = __webpack_require__(112);
	var getScrollbarSize = __webpack_require__(15);
	var PropTypes = React.PropTypes;
	var createObjectWithProperties = __webpack_require__(14);
	var cellMetaDataShape = __webpack_require__(10);
	...
	var Footer = React.createClass({
	  ...
	  getHeaderRows: function getHeaderRows() {
	    ...
	    this.props.headerRows.forEach(function (row, index) {
	      ...
	      headerRows.push(React.createElement(FooterRow, {
	        key: row.ref,
	        ref: function ref(node) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function simpleCellRenderer(objArgs) {
	  var headerText = objArgs.column.rowType === 'header' ? objArgs.column.footerText : '';
	  return React.createElement(
	    'div',
	    { className: 'widget-HeaderCell__value' },
	    headerText
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var BaseHeaderCell = __webpack_require__(111);
	var getScrollbarSize = __webpack_require__(15);
	var ExcelColumn = __webpack_require__(11);
	var ColumnUtilsMixin = __webpack_require__(5);
	var SortableFooterCell = __webpack_require__(125);
	var FilterableHeaderCell = __webpack_require__(51);
	var HeaderCellType = __webpack_require__(45);
	var createObjectWithProperties = __webpack_require__(14);
	__webpack_require__(12);
	...
	var FooterRow = React.createClass({
	  ...
	  propTypes: {
	    ...
	    sortColumn: PropTypes.string,
	    sortDirection: React.PropTypes.oneOf(Object.keys(SortableFooterCell.DEFINE_SORT)),
	    cellRenderer: PropTypes.func,
	  ...
	  getSortableHeaderCell: function getSortableHeaderCell(column) {
	    var sortDirection = this.props.sortColumn === column.key ? this.props.sortDirection : SortableFooterCell.DEFINE_SORT.NONE;
	    return React.createElement(SortableFooterCell, { columnKey: column.key, onSort: this.props.onSort, sortDirection: sortDirection });
	  },
	  ...
	  getCells: function getCells() {
	    ...
	    var _loop = function _loop(i, len) {
	      ...
	      var HeaderCell = BaseHeaderCell; //column.draggable ? this.props.draggableHeaderCell : BaseHeaderCell;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var GridScrollMixin = __webpack_require__(114);
	var DOMMetrics = __webpack_require__(20);
	var cellMetaDataShape = __webpack_require__(10);
	__webpack_require__(23);
	...
	var Grid = React.createClass({
	  ...
	  propTypes: {
	    ...
	    rowGetterFixed: PropTypes.oneOfType([PropTypes.array, PropTypes.func]).isRequired,
	  ...
	  render: function render() {
	    ...
	    var fixGridHeight = this.props.rowHeight * (this.props.freezedRowsFromTopCount + 1);
	    ...
	    return React.createElement(
	      ...
	      this.props.rowsCount >= 1 || this.props.rowsCount === 0 && !this.props.emptyRowsView ? React.createElement(
	        ...
	        { ref: function ref(node) {
	          ...
	          }, className: 'fixed-grid-rows', tabIndex: '0',
	          onKeyDown: this.props.onViewportKeydown, onKeyUp: this.props.onViewportKeyup,
	          ...
	          style: { height: fixGridHeight + "px" }
	        },
	        React.createElement(Viewport, {
	          ref: function ref(node) {
	            _this.viewportFixed = node;
	          },
	          rowKey: this.props.rowKey,
	          width: this.props.columnMetrics.width,
	          rowHeight: this.props.rowHeight,
	          rowRenderer: this.props.rowRenderer,
	          rowGetter: this.props.rowGetterFixed,
	          rowsCount: this.props.freezedRowsFromTopCount || 0,
	          selectedRows: this.props.selectedRows,
	          expandedRows: this.props.expandedRows,
	          columnMetrics: this.props.columnMetrics,
	          totalWidth: this.props.totalWidth,
	          onScroll: this.onFixedScroll,
	          onRows: this.props.onRows,
	          cellMetaData: this.props.cellMetaData,
	          rowOffsetHeight: this.props.rowOffsetHeight || this.props.rowHeight * headerRows.length,
	          minHeight: fixGridHeight,
	      ...
	      this.props.rowsCount >= 1 || this.props.rowsCount === 0 && !this.props.emptyRowsView ? React.createElement(
	        ...
	        { ref: function ref(node) {
	            _this.viewPortContainer = node;
	          }, tabIndex: '0', className: 'grid-rows',
	          onKeyDown: this.props.onViewportKeydown, onKeyUp: this.props.onViewportKeyup,
	          onDoubleClick: this.props.onViewportDoubleClick,
	          onDragStart: this.props.onViewportDragStart,
	          onDragEnd: this.props.onViewportDragEnd },
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  ...
	  onFixedScroll: function onFixedScroll(props) {
	    if (this._scrollLeft !== props.scrollLeft) {
	      this._scrollLeft = props.scrollLeft;
	      this._onScroll();
	    }
	  ...
	  onFooterScroll: function onFooterScroll(e) {
	    return;
	  },
	  _onScroll: function _onScroll() {
	    if (this._scrollLeft !== undefined) {
	      ...
	      if (this.viewport) {
	        ...
	        var fr = document.querySelector('.fixed-grid-rows .react-grid-Canvas');
	        fr.scroll(this._scrollLeft, 0);
	      }
	      if (this.viewportFixed) {
	        this.viewportFixed.setScrollLeft(this._scrollLeft);
	        var rw = document.querySelector('.grid-rows .react-grid-Canvas');
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var ColumnMetrics = __webpack_require__(19);
	var ColumnUtils = __webpack_require__(5);
	var HeaderRow = __webpack_require__(116);
	var getScrollbarSize = __webpack_require__(15);
	var PropTypes = React.PropTypes;
	var createObjectWithProperties = __webpack_require__(14);
	var cellMetaDataShape = __webpack_require__(10);
	...
	var Header = React.createClass({
	  ...
	  hasContextMenu: function hasContextMenu() {
	    return this.props.contextMenu && React.isValidElement(this.props.contextMenu);
	  },
	  getContextMenuContainer: function getContextMenuContainer() {
	    if (this.hasContextMenu()) {
	      var plugins = this.props.window ? this.props.window.ReactDataGridPlugins : window.ReactDataGridPlugins;
	      if (!plugins) {
	        throw new Error('You need to include ReactDataGrid UiPlugins in order to initialise context menu');
	      }
	  ...
	  render: function render() {
	    ...
	    if (this.hasContextMenu()) {
	      var _ContextMenuContainer = this.state.ContextMenuContainer;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var shallowEqual = __webpack_require__(34);
	var BaseHeaderCell = __webpack_require__(44);
	var getScrollbarSize = __webpack_require__(15);
	var ExcelColumn = __webpack_require__(11);
	var ColumnUtilsMixin = __webpack_require__(5);
	var SortableHeaderCell = __webpack_require__(126);
	var FilterableHeaderCell = __webpack_require__(51);
	var HeaderCellType = __webpack_require__(45);
	var createObjectWithProperties = __webpack_require__(14);
	var getInnermostDecoratedInstance = __webpack_require__(131);
	var cellMetaDataShape = __webpack_require__(10);
	__webpack_require__(12);
	...
	var HeaderRow = createReactClass({
	  ...
	  getCells: function getCells() {
	    ...
	    var _loop = function _loop(i, len) {
	      ...
	      var onHeaderContextMenu = function onHeaderContextMenu(e) {
	      ...
	      var cell = React.createElement(
	        'div',
	        { key: i, onContextMenu: onHeaderContextMenu },
	        React.createElement(HeaderCell, {
	          ref: function ref(node) {
	            return _this.cells[i] = getInnermostDecoratedInstance(node);
	          },
	          height: _this.props.height,
	          column: column,
	          renderer: _renderer,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _focusableComponentWrapper = __webpack_require__(129);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(2);
	var ReactDOM = __webpack_require__(3);
	var BaseGrid = __webpack_require__(113);
	var Row = __webpack_require__(33);
	var ExcelColumn = __webpack_require__(11);
	var KeyboardHandlerMixin = __webpack_require__(46);
	var CheckboxEditor = __webpack_require__(52);
	var DOMMetrics = __webpack_require__(20);
	var ColumnMetricsMixin = __webpack_require__(106);
	var RowUtils = __webpack_require__(49);
	var ColumnUtils = __webpack_require__(5);
	var KeyCodes = __webpack_require__(117);
	var isFunction = __webpack_require__(22);
	...
	var ReactDataGrid = React.createClass({
	  ...
	  renderContextMenu: function renderContextMenu(cell) {
	    ...
	    if (React.isValidElement(contextMenu)) {
	      ...
	      return React.createElement('contextMenu', contextMenuProps);
	    }
	  },
	  render: function render() {
	    var _this8 = this;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var ViewportScroll = __webpack_require__(124);
	var cellMetaDataShape = __webpack_require__(10);
	var PropTypes = React.PropTypes;
	...
	module.exports = {
	  ...
	  getVisibleColStart: function getVisibleColStart(scrollLeft) {
	    ...
	    while (remainingScroll >= 0) {
	      columnIndex++;
	      if (columnIndex >= _ColumnUtils2['default'].getSize(this.props.columnMetrics.columns)) {
	        break;
	      }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var SortableFooterCell = React.createClass({
	  displayName: 'SortableFooterCell',
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      ...
	      this.props.column.footerText
	    );
	  }
	});

	module.exports = SortableFooterCell;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  SimpleCellFormatter: __webpack_require__(55)
	};
...
/***/ (function(module, exports) {
	...
	function getInnermostDecoratedInstance(instance) {
	  return instance && instance.getDecoratedComponentInstance ? getInnermostDecoratedInstance(instance.getDecoratedComponentInstance()) : instance;
	}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _GridPropHelpers = __webpack_require__(133);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports.Cell = __webpack_require__(43);
	module.exports.HeaderCell = __webpack_require__(44);
	module.exports.RowComparer = _RowComparer2['default'];
	module.exports.EmptyChildRow = __webpack_require__(109);
	module.exports.RowsContainer = _RowsContainer2['default'];
	module.exports.editors = __webpack_require__(128);
	module.exports.formatters = __webpack_require__(130);
	module.exports.utils = __webpack_require__(56);
	module.exports.shapes = __webpack_require__(119);
	module.exports._constants = __webpack_require__(32);
	module.exports._helpers = __webpack_require__(132);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".react-grid-Footer{box-shadow:0 0 4px 0 #ddd;background:#f9f9f9;position:absolute!important;bottom:15px;left:0;right:15px;border-top:1px solid #ddd}.react-grid-Footer--resizing{cursor:ew-resize}.react-grid-FooterRow{overflow:hidden}.react-grid-FooterCell,.react-grid-FooterRow{-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none}.react-grid-FooterCell{background:#f9f9f9;padding:8px;font-weight:700;border-right:1px solid #ddd;border-bottom:1px solid #ddd;line-height:34px}.react-grid-FooterCell__value{white-space:nowrap;text-overflow:ellipsis;overflow:hidden;position:relative;top:50%;transform:translateY(-50%)}.react-grid-FooterCell__resizeHandle:hover{cursor:ew-resize;background:#ddd}.react-grid-FooterCell--locked:last-of-type{box-shadow:none}.react-grid-FooterCell--resizing .react-grid-FooterCell__resizeHandle{background:#ddd}.react-grid-FooterCell__draggable{cursor:col-resize}.rdg-can-drop>.react-grid-FooterCell{background:#ececec}.react-grid-FooterCell .Select{max-height:30px;font-size:12px;font-weight:400;line-height:34px}.react-grid-FooterCell .Select-control{max-height:30px;border:1px solid #ccc;color:#555;border-radius:3px}.react-grid-FooterCell .is-focused:not(.is-open)>.Select-control{border-color:#66afe9;outline:0;-webkit-box-shadow:inset 0 1px 1px rgba(0,0,0,.075),0 0 8px rgba(102,175,233,.6);box-shadow:inset 0 1px 1px rgba(0,0,0,.075),0 0 8px rgba(102,175,233,.6)}.react-grid-FooterCell .Select-control .Select-placeholder{line-height:20px;color:#999;padding:4px}.react-grid-FooterCell .Select-control .Select-input{max-height:28px;padding:4px;margin-left:0}.react-grid-FooterCell .Select-control .Select-input input{padding:0;height:100%}.react-grid-FooterCell .Select-control .Select-arrow-zone .Select-arrow{border-color:gray transparent transparent;border-width:4px 4px 2.5px}.react-grid-FooterCell .Select-control .Select-value{padding:4px;line-height:20px!important}.react-grid-FooterCell .Select--multi .Select-control .Select-value{padding:0;line-height:16px!important;max-height:20px}.react-grid-FooterCell .Select--multi .Select-control .Select-value .Select-value-icon,.react-grid-FooterCell .Select--multi .Select-control .Select-value .Select-value-label{max-height:20px}.react-grid-FooterCell .Select-control .Select-value .Select-value-label{color:#555!important}.react-grid-FooterCell .Select-menu-outer .Select-option{padding:4px;line-height:20px}.react-grid-FooterCell .Select-menu-outer .Select-menu .Select-option.is-focused,.react-grid-FooterCell .Select-menu-outer .Select-menu .Select-option.is-selected{color:#555}", ""]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".react-grid-Header{box-shadow:0 0 4px 0 #ddd;background:#f9f9f9}.react-grid-Header--resizing{cursor:ew-resize}.react-grid-HeaderRow{overflow:hidden}.react-grid-HeaderCell,.react-grid-HeaderRow{-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none}.react-grid-HeaderCell{background:#f9f9f9;padding:8px;font-weight:700;border-right:1px solid #ddd;border-bottom:1px solid #ddd;line-height:34px;position:relative}.react-grid-HeaderCell .arrow-handle{position:absolute;border-radius:2px;z-index:10;width:12px;height:12px;background-size:7px 4px;right:5px;top:19px;border:1px solid #666;cursor:pointer;display:none}.react-grid-HeaderCell .arrow-handle:after{content:\"\";border-left:3px solid transparent;border-right:3px solid transparent;border-top:4px solid #2f2f2f;border-bottom:none;width:0;height:0;position:absolute;top:3px;left:2px}.react-grid-HeaderCell:hover .arrow-handle,.react-grid-HeaderCell:hover .react-grid-HeaderCell .arrow-handle{display:block}.react-grid-HeaderCell__value{white-space:nowrap;text-overflow:ellipsis;overflow:hidden;position:relative;top:50%;transform:translateY(-50%)}.react-grid-HeaderCell__resizeHandle:hover{cursor:ew-resize;background:#ddd}.react-grid-HeaderCell--locked:last-of-type{box-shadow:none}.react-grid-HeaderCell--resizing .react-grid-HeaderCell__resizeHandle{background:#ddd}.react-grid-HeaderCell__draggable{cursor:col-resize}.rdg-can-drop>.react-grid-HeaderCell{background:#ececec}.react-grid-HeaderCell .Select{max-height:30px;font-size:12px;font-weight:400;line-height:34px}.react-grid-HeaderCell .Select-control{max-height:30px;border:1px solid #ccc;color:#555;border-radius:3px}.react-grid-HeaderCell .is-focused:not(.is-open)>.Select-control{border-color:#66afe9;outline:0;-webkit-box-shadow:inset 0 1px 1px rgba(0,0,0,.075),0 0 8px rgba(102,175,233,.6);box-shadow:inset 0 1px 1px rgba(0,0,0,.075),0 0 8px rgba(102,175,233,.6)}.react-grid-HeaderCell .Select-control .Select-placeholder{line-height:20px;color:#999;padding:4px}.react-grid-HeaderCell .Select-control .Select-input{max-height:28px;padding:4px;margin-left:0}.react-grid-HeaderCell .Select-control .Select-input input{padding:0;height:100%}.react-grid-HeaderCell .Select-control .Select-arrow-zone .Select-arrow{border-color:gray transparent transparent;border-width:4px 4px 2.5px}.react-grid-HeaderCell .Select-control .Select-value{padding:4px;line-height:20px!important}.react-grid-HeaderCell .Select--multi .Select-control .Select-value{padding:0;line-height:16px!important;max-height:20px}.react-grid-HeaderCell .Select--multi .Select-control .Select-value .Select-value-icon,.react-grid-HeaderCell .Select--multi .Select-control .Select-value .Select-value-label{max-height:20px}.react-grid-HeaderCell .Select-control .Select-value .Select-value-label{color:#555!important}.react-grid-HeaderCell .Select-menu-outer .Select-option{padding:4px;line-height:20px}.react-grid-HeaderCell .Select-menu-outer .Select-menu .Select-option.is-focused,.react-grid-HeaderCell .Select-menu-outer .Select-menu .Select-option.is-selected{color:#555}.react-grid-HeaderCell .context-menu{background-color:#fff;position:absolute;left:20px;top:15px;z-index:99;border:1px solid #ddd;min-width:80px;padding:0;display:none}.react-grid-HeaderCell.is-open .context-menu{display:block;display:none}.react-grid-HeaderCell.is-open .context-menu.undefined{display:none}.react-grid-HeaderCell .context-menu ul{list-style:none;margin:0}.react-grid-HeaderCell .context-menu ul li{padding:0 20px}.react-grid-HeaderCell .context-menu ul li:hover{padding:0 20px;background-color:#f3f3f3;cursor:pointer}", ""]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!../node_modules/css-loader/index.js!./react-data-grid-footer.css", function() {
				var newContent = require("!!../node_modules/css-loader/index.js!./react-data-grid-footer.css");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
